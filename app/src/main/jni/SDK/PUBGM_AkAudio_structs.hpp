...
// ScriptStruct AkAudio.AkRangedEmitterInfo
// 0x0018
struct FAkRangedEmitterInfo
{
	float                                              RangeSquare;                                              // 0x0000(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	uint32_t                                           PlayingID;                                                // 0x0004(0x0004) (ZeroConstructor, IsPlainOldData)
