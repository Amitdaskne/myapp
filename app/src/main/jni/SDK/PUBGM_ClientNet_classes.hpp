...
public:
	...
	static void HttpDnsDestroy();
	static int GRomePingDuallink(const struct FString& InHost);
	static int GRomeGetDuallinkStatus();
...
public:
	...
	void BindTwitter();
	void BindTikTok(const struct FString& InExtraJson);
	void BindNosChat();
	void BindLine();
	void BindHMS();
	void BindGooglePlay();
...
// Class ClientNet.MockGameSvrClientNet
