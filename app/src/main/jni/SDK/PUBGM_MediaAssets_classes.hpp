...
public:
	...
	class UMediaPlayer*                                MediaPlayer;                                              // 0x06D8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x50];                                      // 0x06E0(0x0050) MISSED OFFSET
