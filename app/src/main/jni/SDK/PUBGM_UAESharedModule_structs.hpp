...
// ScriptStruct UAESharedModule.UAEBlackboardKeySelectorIndex
// 0x0008 (0x0010 - 0x0008)
struct FUAEBlackboardKeySelectorIndex : public FUAEBlackboardKeySelector
{
	int                                                Index;                                                    // 0x0008(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData)
