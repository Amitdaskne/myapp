...
{
public:
	TArray<struct FDistSquaredToTickInterval>          ConfigTickLODInfo;                                        // 0x0178(0x0010) (ZeroConstructor, Config)
	TArray<class UTweenContainer*>                     mTweenContainers;                                         // 0x0188(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData00[0xF0];                                      // 0x0198(0x00F0) MISSED OFFSET
