...
public:
	...
	TMap<TEnumAsByte<ECustomMovmentMode>, float>       CustomMovement_BlendTime;                                 // 0x0B78(0x0050) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance)
	...
	TEnumAsByte<ECharacterPoseType>                    PoseType;                                                 // 0x0C34(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EWeaponType>                           WeaponType;                                               // 0x0C35(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ECharacterPoseType>                    InterruptCachePose;                                       // 0x0C36(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ECharacterPoseType>                    RecoverCharPose;                                          // 0x0C37(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
public:
	...
	TEnumAsByte<EWeaponType>                           C_WeaponType;                                             // 0x0B04(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	TEnumAsByte<ECharacterPoseType>                    C_PoseType;                                               // 0x0B1A(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TEnumAsByte<EMovementMode>                         C_LastMovementMode;                                       // 0x0B1B(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	TEnumAsByte<ECustomMovmentMode>                    C_CustomMovementMode;                                     // 0x0B61(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
...
public:
	...
	TEnumAsByte<ECharacterFollowType>                  FollowType;                                               // 0x0B58(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EHoldingHandsIKMode>                   EHandIKMode;                                              // 0x0B59(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
