...
public:
	...
	void DefineCustom();
	void Define();
	int CustomNumByType(TEnumAsByte<ECustomBlockType> CustomType);
...
public:
	...
	struct FScriptDelegate                             OnGetLocaleString;                                        // 0x1370(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnCallCustomSelectObject;                                 // 0x1380(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnReceiveCustomSelectObject;                              // 0x1390(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnCheckShowCustomSelection;                               // 0x13A0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnShowPresetPanelHandler;                                 // 0x13B0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnCheckShowPresetFilterBtn;                               // 0x13C0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnModifyTip;                                              // 0x13D0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnAddBlockyLog;                                           // 0x13E0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnGetValidString;                                         // 0x13F0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnCheckStringValid;                                       // 0x1400(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnMessageData;                                            // 0x1410(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnIsCurrentCultureLTR;                                    // 0x1420(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnGetTextLen;                                             // 0x1430(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnPlayPresetSound;                                        // 0x1440(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnOpenGuide;                                              // 0x1450(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnSetGraphSetting;                                        // 0x1460(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnGetBlockNewState;                                       // 0x1470(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnSetBlockNewState;                                       // 0x1480(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnGetSearchHistorys;                                      // 0x1490(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnSetSearchHistorys;                                      // 0x14A0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnGetUrlIconAsset;                                        // 0x14B0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnCallUrlIconAssetToLoad;                                 // 0x14C0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnCallPresetSelectedCode;                                 // 0x14D0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
...
public:
	...
	TEnumAsByte<ECustomBlockType> GetCustomType();
	void ClosePopUp();
};
...
{
public:
	TEnumAsByte<EBlockyAccessType>                     Access;                                                   // 0x0128(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
public:
	...
	TEnumAsByte<ECustomBlockType>                      Type;                                                     // 0x0048(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0049(0x0007) MISSED OFFSET
...
public:
	...
	TEnumAsByte<EBlockyVarInitType>                    InitType;                                                 // 0x0139(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
