...
// Enum Skill.ESkillBaseWidgetType
enum class ESkillBaseWidgetType : uint8_t
{
	ESkillBaseWidgetType__None     = 0,
	ESkillBaseWidgetType__SkillEffect = 1,
	ESkillBaseWidgetType__SkillCondition = 2,
	ESkillBaseWidgetType__SkillPicker = 3,
	ESkillBaseWidgetType__SkillLocationPicker = 4,
	ESkillBaseWidgetType__ESkillBaseWidgetType_MAX = 5
};
...
struct FUTSkillCreateData
{
	...
	bool                                               bEnableRepeat;                                            // 0x0024(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	class UUTSkillEffect*                              SkillActiveAction;                                        // 0x0038(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UUTSkillEffect*                              SkillCloseAction;                                         // 0x0040(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	TArray<class UUTSkillCDBase*>                      SkillCDs;                                                 // 0x0048(0x0010) (ZeroConstructor, Transient)
...
struct FUTSkillRuntimeData
{
	...
	bool                                               bSkillSelect;                                             // 0x0008(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
	bool                                               bShowSkillMainWidget;                                     // 0x0009(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
...
struct FSkillActiveData
{
	...
	bool                                               bSelect;                                                  // 0x0009(0x0001) (ZeroConstructor, IsPlainOldData)
...
// ScriptStruct Skill.ActionMetaData
// 0x0020
struct FActionMetaData
{
	ESkillBaseWidgetType                               ActionType;                                               // 0x0000(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0001(0x0007) MISSED OFFSET
...
// ScriptStruct Skill.ActionsMetaData
// 0x0050
struct FActionsMetaData
{
	TMap<struct FString, struct FActionMetaData>       ActionMetaData;                                           // 0x0000(0x0050) (Edit, BlueprintVisible, ZeroConstructor)
};

// ScriptStruct Skill.SkillMetaData
// 0x0060
struct FSkillMetaData
{
	struct FString                                     SkillName;                                                // 0x0000(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	TMap<int, struct FActionsMetaData>                 PhaseToActionsMetaData;                                   // 0x0010(0x0050) (Edit, BlueprintVisible, ZeroConstructor)
};
