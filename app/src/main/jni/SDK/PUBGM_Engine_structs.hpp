...
// Enum Engine.EPhysicsContactState
enum class EPhysicsContactState : uint8_t
{
	EPhysicsContactState__None     = 0,
	EPhysicsContactState__Found    = 1,
	EPhysicsContactState__Persist  = 2,
	EPhysicsContactState__Lost     = 3,
	EPhysicsContactState__EPhysicsContactState_MAX = 4
};
...
enum class EMaterialUsage : uint8_t
{
	...
	MATUSAGE_ColorInstancedStaticMeshes = 9,
	...
	MATUSAGE_IBL                   = 14,
	MATUSAGE_GFur                  = 15,
	MATUSAGE_VertexPointLight      = 16,
	MATUSAGE_DestructibleHide      = 17,
	MATUSAGE_DestructibleDetach    = 18,
	MATUSAGE_DestructibleSlide     = 19,
...
// Enum Engine.EParticleEngineVectorParamTags
enum class EParticleEngineVectorParamTags : uint8_t
{
	EngineVector_Position          = 0,
	EngineVector_Velocity          = 1,
	EngineVector_XAxis             = 2,
	EngineVector_YAxis             = 3,
	EngineVector_ZAxis             = 4,
	EngineVector_Scale             = 5,
	EngineVector_MAX               = 6
};


// Enum Engine.EParticleEngineFloatParamTags
enum class EParticleEngineFloatParamTags : uint8_t
{
	EngineFloat_VelocityMagnitude  = 0,
	EngineFloat_DeltaTime          = 1,
	EngineFloat_Time               = 2,
	EngineFloat_RealTime           = 3,
	EngineFloat_TimeSinceRendered  = 4,
	EngineFloat_QualityLevel       = 5,
	EngineFloat_MAX                = 6
};
...
// Enum Engine.ESkeletaTickMode
enum class ESkeletaTickMode : uint8_t
{
	ESkeletaTickMode__TICK_ALL     = 0,
	ESkeletaTickMode__TICK_ANI_NOT_LOD = 1,
	ESkeletaTickMode__TICK_NONE    = 2,
	ESkeletaTickMode__TICK_LOD_NOT_ANI = 3,
	ESkeletaTickMode__TICK_MAX     = 4
};
...
struct FTickFunction
{
	...
	unsigned char                                      UnknownData03[0x6C];                                      // 0x0044(0x006C) MISSED OFFSET
};
...
struct FRepMovement
{
	...
	struct FName                                       LocationQuantizationLODGroup;                             // 0x0030(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	EVectorQuantization                                LocationQuantizationLevel;                                // 0x0038(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	EVectorQuantization                                VelocityQuantizationLevel;                                // 0x0039(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	ERotatorQuantization                               RotationQuantizationLevel;                                // 0x003A(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      bSimulatedPhysicSleep : 1;                                // 0x003B(0x0001) (Transient)
	unsigned char                                      bRepPhysics : 1;                                          // 0x003B(0x0001) (Transient)
	unsigned char                                      bPhysicsHit : 1;                                          // 0x003B(0x0001) (Transient)
	unsigned char                                      LocationQuantizationLODEnabled : 1;                       // 0x003B(0x0001) (Edit, DisableEditOnInstance)
	unsigned char                                      ForcedLocationQuantizationLOD;                            // 0x003C(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
...
struct FPostProcessSettings
{
	...
	unsigned char                                      bOverride_BackgroundBlur : 1;                             // 0x0012(0x0001) (Edit, BlueprintVisible)
...
// ScriptStruct Engine.SplineMeshInstanceParams
// 0x00A0
struct FSplineMeshInstanceParams
{
	bool                                               bHide;                                                    // 0x0000(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0001(0x0007) MISSED OFFSET
	class UBodySetup*                                  BodySetup;                                                // 0x0008(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FBoxSphereBounds                            InstanceBound;                                            // 0x0010(0x001C) (Edit, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
	struct FVector4                                    InstanceParams[0x3];                                      // 0x0030(0x0010) (Edit, IsPlainOldData)
...
struct FUserDetailSetting
{
	...
	int                                                PUBGDeviceFPSVerySmoothExpand;                            // 0x0078(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                PUBGDeviceFPSLowExpand;                                   // 0x007C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                PUBGDeviceFPSMidExpand;                                   // 0x0080(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                PUBGDeviceFPSHighExpand;                                  // 0x0084(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                PUBGDeviceFPSHDRExpand;                                   // 0x0088(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                PUBGDeviceFPSUltralHighExpand;                            // 0x008C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                PUBGDeviceFPSUltimateHighExpand;                          // 0x0090(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
{
	TEnumAsByte<EReferenceType>                        ReferenceType;                                            // 0x0032(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
{
	EPhysicsContactState                               ContactState;                                             // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0001(0x0007) MISSED OFFSET
	TArray<struct FRigidBodyContactInfo>               ContactInfos;                                             // 0x0008(0x0010) (ZeroConstructor)
	struct FVector                                     TotalNormalImpulse;                                       // 0x0018(0x000C) (IsPlainOldData)
	struct FVector                                     TotalFrictionImpulse;                                     // 0x0024(0x000C) (IsPlainOldData)
};
