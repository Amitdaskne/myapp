...
struct FGameModePlayerBattleResultData
{
	...
	int                                                FirstMoveBattles;                                         // 0x04D4(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                TotalBattles;                                             // 0x04D8(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              DamageAmountFPP;                                          // 0x04DC(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                FPPSwitchTimes;                                           // 0x04E0(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                MeleeKillTimes;                                           // 0x04E4(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              MeleeDamageAmount;                                        // 0x04E8(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              RangedDamagedAmount;                                      // 0x04EC(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              VehicleDamageAmount;                                      // 0x04F0(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                OpenAirDropBoxesNum;                                      // 0x04F4(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                FollowState;                                              // 0x04F8(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x4];                                       // 0x04FC(0x0004) MISSED OFFSET
	TArray<struct FString>                             DestroyVehicleFlow;                                       // 0x0500(0x0010) (ZeroConstructor)
	int                                                UseHelicoperNum;                                          // 0x0510(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              UseHelicoperDistance;                                     // 0x0514(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                RevivalNum;                                               // 0x0518(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                BeRevivedNum;                                             // 0x051C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                DrivingHelicopterTime;                                    // 0x0520(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                InHelicopterTime;                                         // 0x0524(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                SnowBoardJumpActionCount;                                 // 0x0528(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                EmoteOnTelpherCount;                                      // 0x052C(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<int>                                        FindBlackMonsterIDs;                                      // 0x0530(0x0010) (ZeroConstructor)
	int                                                KillSnowManCount;                                         // 0x0540(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x4];                                       // 0x0544(0x0004) MISSED OFFSET
	TMap<EEventCounterDefine, int>                     EventCounterMap;                                          // 0x0548(0x0050) (ZeroConstructor)
	TMap<int, int>                                     GeneralCounterMap;                                        // 0x0598(0x0050) (ZeroConstructor)
	struct FTLog_Micphone                              MicphoneTlog;                                             // 0x05E8(0x0018)
	int                                                NormalItemNum;                                            // 0x0600(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                SeniorItemNum;                                            // 0x0604(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<struct FSpecialWeaponRecord>                SpecicalWeaponRecordList;                                 // 0x0608(0x0010) (ZeroConstructor)
};
