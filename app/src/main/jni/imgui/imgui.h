...
namespace ImGui
{
    ...
    IMGUI_API void          StyleColorsblack(ImGuiStyle* dst = NULL);    // new, recommended style (default)
    IMGUI_API void          StyleColorsLight(ImGuiStyle* dst = NULL);   // best used with borders and a custom, thicker font
    IMGUI_API void          StyleColorsClassic(ImGuiStyle* dst = NULL); // classic imgui style

    IMGUI_API void          StyleColorsYellow(ImGuiStyle* dst = NULL);    // new, recommended style (default)
    
   IMGUI_API void          StyleColorsRed(ImGuiStyle* dst = NULL);    // new, recommended style (default)
   
   IMGUI_API void          StyleColorsGreen(ImGuiStyle* dst = NULL);    // new, recommended style (default)
       
     IMGUI_API void          StyleColorsBlue(ImGuiStyle* dst = NULL);    // new, recommended style (default)
           
      IMGUI_API void          StyleColorsOrange(ImGuiStyle* dst = NULL);    // new, recommended style (default)
               
      IMGUI_API void          StyleColorsPink(ImGuiStyle* dst = NULL);    // new, recommended style (default)
...
struct ImDrawList
{
    ...
    IMGUI_API void  AddTextStorke(const ImFont* font, float font_size, int x, int y, ImU32 col, const char* text_begin, const char* text_end = NULL, float wrap_width = 0.0f, const ImVec4* cpu_fine_clip_rect = NULL);
